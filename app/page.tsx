...
const UserRow = ({ name, email }: { name: string; email: string }) => {
  return (
    ...
    p-4 border rounded-4 border-gray my-1  cursor-default hover:bg-slate-200 transition-all"
    >
  ...
  return (
    <div className="bg-google-bw  visible absolute flex h-auto min-h-full w-full opacity-100 contain-style">
      <div
        ...
        min-w-0 flex-1-auto "
      >
        <div className="pt-20 px-10 h-full w-full">
          <div className="w-full flex justify-center items-center">
            <h1 className="text-4xl font-bold text-slate-900">Requests for Teacher Role</h1>
          </div>
